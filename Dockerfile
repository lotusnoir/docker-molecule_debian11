...
RUN apt-get update && apt-get -y upgrade \
    && apt-get install -y --no-install-recommends locales systemd systemd-sysv sudo python3 python3-apt python3-pip iproute2 net-tools procps wget ca-certificates \
